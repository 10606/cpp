...
public:
    ...
    explicit big_integer (int32_t val):
        size(1),
        signed_((val & c1_) != 0),
        data(1)
    {
...
big_integer & big_integer::operator = (big_integer a)
{
    swap(a);
    return *this;
}
...
{
    return big_integer::comp_fe(a, b);
}
...
bool operator > (big_integer a, big_integer b)
{
    return big_integer::comp_fb(a, b);
}
...
bool operator < (big_integer a, big_integer b)
{
    return !big_integer::comp_fbe(a, b);
}
