...
public:
    ...
    big_integer (uint32_t * data_, size_t size_, bool singed__);
...
private:
    ...
    static inline big_integer pre_add(big_integer const & a, big_integer & b, bool type_op);
    ...
    static inline std::pair <size_t, uint64_t> pre_div_bb(big_integer & reminder, big_integer & b); //reminder and b cloned
    static inline big_integer div_bb(big_integer & a, big_integer & b); //reminder and b cloned
    static inline big_integer shr_bb(big_integer const & a, uint32_t const & b);
    static inline big_integer shl_bb(big_integer const & a, uint32_t const & b);
...
public:
    ...
    friend big_integer & operator <<= (big_integer & a, big_integer const & b);
    friend big_integer & operator >>= (big_integer & a, big_integer const & b);
    friend std::string to_string(big_integer const & ss);
};
