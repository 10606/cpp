...
big_integer::big_integer (uint32_t * data_, size_t size_, bool signed__):
    size(size_),
    signed_(signed__),
    data(data_)
{}
...
inline std::pair <size_t, uint64_t> big_integer::pre_div_bb(big_integer & reminder, big_integer & b) //reminder and b cloned
{
    uint64_t d = 0; 
...
inline big_integer big_integer::div_bb(big_integer & reminder, big_integer & b) //reminder and b cloned
{
    uint64_t digit = 0; 
    size_t pos;
    uint64_t d;
    std::pair <size_t, uint64_t> tmp = pre_div_bb(reminder, b);
    pos = tmp.first;
    d = tmp.second;
    big_integer res;
...
inline big_integer big_integer::shr_bb(big_integer const & a, uint32_t const & b) 
{
...
inline big_integer big_integer::shl_bb(big_integer const & a, uint32_t const & b) 
{
    size_t max_size = a.size + (b / 32) + 1;
    size_t tail = b % 32;
    size_t shift = b / 32;
...
inline big_integer big_integer::dec_postfix(big_integer & a) //a cloned
{
...
inline big_integer & big_integer::dec_prefix(big_integer & a) //a cloned
{
    bool cf = 1;
...
inline big_integer big_integer::inc_postfix(big_integer & a) //a cloned
{
    size_t max_size = a.size;
...
inline big_integer & big_integer::inc_prefix(big_integer & a) //a cloned
{
    if (a.data.data[a.size - 1] & big_integer::c11_)
    {
        big_integer res;
...
big_integer big_integer::pre_add(big_integer const & a, big_integer & b, bool type_op)
{
...
{
    return big_integer::pre_add(a, b, 1);
}
big_integer operator + (big_integer a, big_integer b)
{
    return big_integer::pre_add(a, b, 1);
